...
function Trainer({ profile, t, onChatActive, onAddWord }) {
  ...
  /* Tutor (Franz 06.09.): freier Erklaer-Chat auf Deutsch — er sagt,
     was er wissen oder ueben will; Wortschatz + Grammatik-Stand sind
     der Kontext, jedes koreanische Wort steht mit Uebersetzung */
  function starteTutor() {
    setAktiv({ mode: 'tutor', scenario: '', title: `🎓 ${t.modeTutor}` })
  }
    ...
    <div className="screen sets-screen">
      ...
      <main className="trainer-menu">
        <div className="mode-grid">
          ...
          {/* Tutor: fragen, erklaeren lassen, Aufgaben bestellen — auf Deutsch */}
          <button className="mode-card" onClick={starteTutor}>
            <span className="mode-emoji">🎓</span>
