...
/* ============================================================
   Deutschland-Motive für die deutsche Seite der App.
   Gegenstück zu den Korea-Motiven weiter oben.
   ============================================================ */

/* Kölner Dom — Home-Icon auf der deutschen Seite */
...
/* Stadtsilhouette: Brandenburger Tor, Kölner Dom, Fernsehturm,
   dazu ein Kranichpaar — das Gegenstück zur Bergkette. */
export function SkylineBand() {
  ...
  return (
    <div className="mountain-band" aria-hidden="true">
      <svg viewBox="0 0 390 74" preserveAspectRatio="none">
        <path fill={far} d="M0 74 L0 52 L18 52 L26 44 L34 52 L52 52 L52 46 L70 46 L70 40 L78 40 L78 52 L104 52 L112 43 L120 52 L150 52 L150 47 L168 47 L168 52 L196 52 L204 44 L212 52 L240 52 L240 48 L262 48 L262 52 L290 52 L298 43 L306 52 L334 52 L334 47 L356 47 L356 52 L390 52 L390 74 Z" />
        <path fill={mid} d="M212 74 L212 32 L217 10 L222 32 L222 44 L236 44 L236 32 L241 10 L246 32 L246 74 Z" />
        <rect x="336" y="26" width="4" height="48" fill={mid} />
        <circle cx="338" cy="24" r="6.5" fill={mid} />
        <rect x="337.2" y="5" width="1.6" height="13" fill={mid} />
        ...
        <path fill={near} d="M0 74 L0 60 L14 60 L20 53 L26 60 L26 74 Z" />
        <path fill={near} d="M126 74 L126 61 L146 61 L146 74 Z M154 74 L154 57 L160 51 L166 57 L166 74 Z M174 74 L174 62 L192 62 L192 74 Z" />
        <path fill={near} d="M42 58 L110 58 L110 63 L42 63 Z" />
        <path fill={near} d="M66 51 L86 51 L86 58 L66 58 Z" />
        <path fill={near} d="M68 47 L70 47 L70 51 L68 51 Z M73 46 L75 46 L75 51 L73 51 Z M78 47 L80 47 L80 51 L78 51 Z M83 48 L85 48 L85 51 L83 51 Z" />
        <path fill={near} d="M46 63 L51 63 L51 74 L46 74 Z M60 63 L65 63 L65 74 L60 74 Z M74 63 L79 63 L79 74 L74 74 Z M88 63 L93 63 L93 74 L88 74 Z M102 63 L107 63 L107 74 L102 74 Z" />
        <rect x="0" y="70" width="390" height="4" fill={near} />
      </svg>
      <div className="mountain-fade" />
    </div>
  )
...
/* Kleine Stadtkante am Fuss der Lernkarte */
