...
const de = {
  ...
  nfOeffnen: 'Frag den Trainer dazu',
  nfPlatzhalter: 'Antworten oder nachfragen…',
  nfSenden: 'Senden',
  nfFehler: 'Der Trainer ist gerade nicht erreichbar — versuch es nochmal.',
  ltFeedbackLaedt: 'Der Trainer schaut es sich an…',
  swFehler: 'Der Trainer ist gerade nicht erreichbar. Dein Text bleibt erhalten — versuch es gleich nochmal.',
